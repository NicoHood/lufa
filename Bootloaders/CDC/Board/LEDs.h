 ...
 *    <tr><td>LEDS_LED2</td><td>Yellow</td><td>TX</td><td>Low</td><td>PORTE.5</td></tr>
...
#define __LEDS_LEONARDO_H__
	...
	/* Private Interface - For use in library only: */
		...
		/* Macros: */
			...
			#define LEDS_PORTE_LEDS       (LEDS_LED1)
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			#define LEDS_LED1        (1 << PORTE6)

			/** LED mask for the second LED on the board. */
			#define LEDS_LED2        (1 << PORTB6)
		...
		/* Inline Functions: */
			...
			static inline void LEDs_ToggleLEDs(const uint8_t LEDMask)
			{
				...
				PIND  = (LEDMask & LEDS_PORTE_LEDS);
			}

			static inline uint8_t LEDs_GetLEDs(void) ATTR_WARN_UNUSED_RESULT;
			static inline uint8_t LEDs_GetLEDs(void)
			{
				return ((~PORTB & LEDS_PORTB_LEDS) | (~PORTE & LEDS_PORTE_LEDS));
			}
		#endif
